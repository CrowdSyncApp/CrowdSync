...
const LoginScreen = () => {
  ...
  useEffect(() => {
      ...
      if (isUserLoggedIn) {
        navigation.navigate('FindSession'); // Navigate to the Home screen or any other authenticated screen
      }
    ...
    <View>
      ...
      <TouchableOpacity onPress={handleSignUp} style={{ backgroundColor: 'green', padding: 10 }}>
        ...
        <TouchableOpacity onPress={handleForgotPassword}>
                <Text style={{ color: 'blue', textAlign: 'center', marginTop: 10 }}>Forgot Password?</Text>
              </TouchableOpacity>
    </View>
  );
};
